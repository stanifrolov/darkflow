class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_2_lstm_after_gt_leaky/', 'path to backup folder')
    self.define('summary', './summary_2_lstm_after_gt_leaky/', 'path to TensorBoard summaries directory')

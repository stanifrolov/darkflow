class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_overfit_motnet_orig_yolo/', 'path to backup folder')
    self.define('summary', './summary_overfit_motnet__orig_yolo/', 'path to TensorBoard summaries directory')

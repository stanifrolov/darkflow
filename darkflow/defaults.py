class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_2_convlstm_before_gt_k3_noobj3/', 'path to backup folder')
    self.define('summary', './summary_2_convlstm_before_gt_k3_noobj3/', 'path to TensorBoard summaries directory')

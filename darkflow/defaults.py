class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_train_motnet_with_convlstm_identity_b2_s12/', 'path to backup folder')
    self.define('summary', './summary_train_motnet_with_convlstm_identity_b2_s12/', 'path to TensorBoard summaries directory')

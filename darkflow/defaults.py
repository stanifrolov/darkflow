class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_2_convlstm_after_kernel/', 'path to backup folder')
    self.define('summary', './summary_2_convlstm_after_kernel/', 'path to TensorBoard summaries directory')

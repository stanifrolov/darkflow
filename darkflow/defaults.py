class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_train_motnet_with_convlstm_before_conv_b4_s6_lr_1e-6/', 'path to backup folder')
    self.define('summary', './summary_train_motnet_with_convlstm_before_conv_b4_s6_lr_1e-6/', 'path to TensorBoard summaries directory')

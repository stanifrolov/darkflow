class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_train_motnet_with_convlstm_identity_b4_s6_lr_5e-6/', 'path to backup folder')
    self.define('summary', './summary_train_motnet_with_convlstm_identity_b4_s6_lr_5e-6/', 'path to TensorBoard summaries directory')
    ...
    self.define('lr', 5e-6, 'learning rate')

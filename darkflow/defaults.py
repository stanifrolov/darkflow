class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_train_motnet_convlstm/', 'path to backup folder')
    self.define('summary', './summary_train_motnet_convlstm/', 'path to TensorBoard summaries directory')

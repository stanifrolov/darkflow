class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('dataset', '/home_local_SSD/frolov/MOTC/MOT17/train/', 'path to dataset directory')
    #self.define('dataset', '/storage_local/frolov/MOTC/MOT17/train/', 'path to dataset directory')

class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_finetune_yolo_noobj3/', 'path to backup folder')
    self.define('summary', './summary_finetune_yolo_noobj3/', 'path to TensorBoard summaries directory')

class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_1_lstm_after_gt_leaky_noobj3/', 'path to backup folder')
    self.define('summary', './summary_1_lstm_after_gt_leaky_noobj3/', 'path to TensorBoard summaries directory')

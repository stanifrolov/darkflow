class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_1_convlstm_after_gt_lr/', 'path to backup folder')
    self.define('summary', './summary_1_convlstm_after_gt_lr/', 'path to TensorBoard summaries directory')
    ...
    self.define('epoch', 150, 'number of epoch')

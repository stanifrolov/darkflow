class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_overfit_motnet_freezed_orig_yolo/', 'path to backup folder')
    self.define('summary', './summary_overfit_motnet_freezed_orig_yolo/', 'path to TensorBoard summaries directory')

class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_test_predict_fluent/', 'path to backup folder')
    self.define('summary', './summary_test_predict_fluent/', 'path to TensorBoard summaries directory')

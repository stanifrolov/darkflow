class argHandler(dict):
  ...
  def setDefaults(self):
    ...
    self.define('backup', './ckpt_1_convlstm_before_gt_k3_freezed/', 'path to backup folder')
    self.define('summary', './summary_1_convlstm_before_gt_k3_freezed/', 'path to TensorBoard summaries directory')
